...
def listaEventos():
    ...
    eventos = "<ul>"
    for row in rows:
        eventos = eventos + "<li>id: " + row[1] + "</li><li>Dispositivo: " + row[2] + "</li><li>Temperatura: " + str(row[3]) + "</li><li>Umidade: " + str(row[4]) + "</li><li>Som: " + str(row[5]) + + "</li><li>Luminosidade: " + str(row[6]) + "</li><li>-------</li>"
    eventos += "</ul>" 
